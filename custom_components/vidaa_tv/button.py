...
The key is simply ``KEY_AUDIO``. It appears in none of the published VIDAA key
lists (Krazy998, hisensetv, pyvidaa), so it had to be found by sweeping
candidate names against the TV.
"""
